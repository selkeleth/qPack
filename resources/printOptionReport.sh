...
# A large % of this code was essentially done by AI
#
# Prints a report for the given target directory with
# summaries of the file sizes and bitrate usage by year,
# overall, and with one archive and one YTD torrent.
#
